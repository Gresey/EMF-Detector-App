          ...
          RadialAxis(
            ...
            ranges: <GaugeRange>[
              GaugeRange(
                ...
                color:AppColors.green,label: 'SAFE',startWidth: 25,
                endWidth: 25,labelStyle:
                 GaugeTextStyle(
                  color: Colors.white,fontWeight: FontWeight.bold),),
                    GaugeRange(
                startValue: 200, endValue: 500,
                color:AppColors.orange,label: 'MODERATE',startWidth: 25,
                endWidth: 25,labelStyle:
                 GaugeTextStyle(
                  color: Colors.white,fontWeight: FontWeight.bold),),
                    GaugeRange(
                startValue: 500, endValue: 1000,
                color:AppColors.red,label: 'DANGER',startWidth: 25,
                endWidth: 25,labelStyle:
                 GaugeTextStyle(
                  color: Colors.white,fontWeight: FontWeight.bold),),
            ...
            annotations:<GaugeAnnotation> [
              GaugeAnnotation(angle: 90,positionFactor: 0.5, widget: Container(child: Text(value.magnitude.toStringAsFixed(2),style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),))
              ,
            ],
          )
